...
import { CoursesPaths } from '../const.js';
...
export const PageRoutes = {
    NET_API_BASICS: CoursesPaths.NET_API_BASICS,
...
export const RoutePath = {
    NET_API_BASICS: CoursesPaths.NET_API_BASICS,
    GETTING_STARTED_DOTNET_API: CoursesPaths.NET_API_BASICS + PageRoutes.GETTING_STARTED_DOTNET_API,
    ENTITY_FRAMEWORK_CORE_SETUP: CoursesPaths.NET_API_BASICS + PageRoutes.ENTITY_FRAMEWORK_CORE_SETUP,
    CREATING_API_CONTROLLERS: CoursesPaths.NET_API_BASICS + PageRoutes.CREATING_API_CONTROLLERS,
    MANIPULATING_RESOURCES_VALIDATING_INPUT: CoursesPaths.NET_API_BASICS + PageRoutes.MANIPULATING_RESOURCES_VALIDATING_INPUT,
    VALIDATING_INPUT_DATA_ANNOTATIONS: CoursesPaths.NET_API_BASICS + PageRoutes.VALIDATING_INPUT_DATA_ANNOTATIONS,
    WORKING_WITH_SERVICES_DEPENDENCY_INJECTION: CoursesPaths.NET_API_BASICS + PageRoutes.WORKING_WITH_SERVICES_DEPENDENCY_INJECTION,
    HANDLING_ASYNCHRONOUS_REQUESTS: CoursesPaths.NET_API_BASICS + PageRoutes.HANDLING_ASYNCHRONOUS_REQUESTS,
    SEARCHING_FILTERING_PAGING_RESOURCES: CoursesPaths.NET_API_BASICS + PageRoutes.SEARCHING_FILTERING_PAGING_RESOURCES,
    SECURING_API_AUTHENTICATION_AUTHORIZATION: CoursesPaths.NET_API_BASICS + PageRoutes.SECURING_API_AUTHENTICATION_AUTHORIZATION,
    ADVANCED_API_SECURITY_OAUTH_JWT_HTTPS: CoursesPaths.NET_API_BASICS + PageRoutes.ADVANCED_API_SECURITY_OAUTH_JWT_HTTPS,
    HANDLING_CORS_REQUESTS: CoursesPaths.NET_API_BASICS + PageRoutes.HANDLING_CORS_REQUESTS,
    LOGGING_EXCEPTION_HANDLING_MIDDLEWARE: CoursesPaths.NET_API_BASICS + PageRoutes.LOGGING_EXCEPTION_HANDLING_MIDDLEWARE,
    ERROR_RESPONSE_STATUS_CODES: CoursesPaths.NET_API_BASICS + PageRoutes.ERROR_RESPONSE_STATUS_CODES,
    API_RATE_LIMITING: CoursesPaths.NET_API_BASICS + PageRoutes.API_RATE_LIMITING,
    VERSIONING_DOCUMENTING_API_SWAGGER: CoursesPaths.NET_API_BASICS + PageRoutes.VERSIONING_DOCUMENTING_API_SWAGGER,
    UNIT_TESTING_XUNIT: CoursesPaths.NET_API_BASICS + PageRoutes.UNIT_TESTING_XUNIT,
    MONITORING_APPLICATION_HEALTHCHECKS: CoursesPaths.NET_API_BASICS + PageRoutes.MONITORING_APPLICATION_HEALTHCHECKS,
    IMPROVING_PERFORMANCE_CACHING: CoursesPaths.NET_API_BASICS + PageRoutes.IMPROVING_PERFORMANCE_CACHING,
    SCALING_OPTIMIZING_API: CoursesPaths.NET_API_BASICS + PageRoutes.SCALING_OPTIMIZING_API
};
