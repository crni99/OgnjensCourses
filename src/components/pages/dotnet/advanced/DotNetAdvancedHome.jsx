    ...
    return (
        <>
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.GETTING_STARTED_DOTNET_API}`}
            />
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.ENTITY_FRAMEWORK_CORE_SETUP}`}
            />
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.CREATING_API_CONTROLLERS}`}
            />
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.MANIPULATING_RESOURCES_VALIDATING_INPUT}`}
            />
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.VALIDATING_INPUT_DATA_ANNOTATIONS}`}
            />
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.WORKING_WITH_SERVICES_DEPENDENCY_INJECTION}`}
            />
            ...
            <HomeSection
                ...
                paragraph2="Write non-blocking, async methods to improve the responsiveness
                        of your API."
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.HANDLING_ASYNCHRONOUS_REQUESTS}`}
            />
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.SEARCHING_FILTERING_PAGING_RESOURCES}`}
            />
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.SECURING_API_AUTHENTICATION_AUTHORIZATION}`}
            />
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.ADVANCED_API_SECURITY_OAUTH_JWT_HTTPS}`}
            />
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.HANDLING_CORS_REQUESTS}`}
            />
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.LOGGING_EXCEPTION_HANDLING_MIDDLEWARE}`}
            />
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.ERROR_RESPONSE_STATUS_CODES}`}
            />
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.API_RATE_LIMITING}`}
            />
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.VERSIONING_DOCUMENTING_API_SWAGGER}`}
            />
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.UNIT_TESTING_XUNIT}`}
            />
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.MONITORING_APPLICATION_HEALTHCHECKS}`}
            />
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.IMPROVING_PERFORMANCE_CACHING}`}
            />
            ...
            <HomeSection
                ...
                targetURL={`${CoursesPaths.NET_API_BASICS}${PageRoutes.SCALING_OPTIMIZING_API}`}
            />
        </>
    );
}