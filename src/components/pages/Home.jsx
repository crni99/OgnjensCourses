...
import { PageRoutes } from "../../utils/const";
    ...
    return (
        <>
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.GETTING_STARTED_DOTNET_API}
            />
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.ENTITY_FRAMEWORK_CORE_SETUP}
            />
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.CREATING_API_CONTROLLERS}
            />
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.MANIPULATING_RESOURCES_VALIDATING_INPUT}
            />
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.VALIDATING_INPUT_DATA_ANNOTATIONS}
            />
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.WORKING_WITH_SERVICES_DEPENDENCY_INJECTION}
            />
            ...
            <HomeSection
                ...
                paragraph2="Write non-blocking, async methods to improve the responsiveness
                        of your API."
                targetURL={PageRoutes.HANDLING_ASYNCHRONOUS_REQUESTS}
            />
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.SEARCHING_FILTERING_PAGING_RESOURCES}
            />
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.SECURING_API_AUTHENTICATION_AUTHORIZATION}
            />
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.ADVANCED_API_SECURITY_OAUTH_JWT_HTTPS}
            />
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.HANDLING_CORS_REQUESTS}
            />
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.LOGGING_EXCEPTION_HANDLING_MIDDLEWARE}
            />
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.ERROR_RESPONSE_STATUS_CODES}
            />
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.API_RATE_LIMITING}
            />
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.VERSIONING_DOCUMENTING_API_SWAGGER}
            />
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.UNIT_TESTING_XUNIT}
            />
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.MONITORING_APPLICATION_HEALTHCHECKS}
            />
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.IMPROVING_PERFORMANCE_CACHING}
            />
            ...
            <HomeSection
                ...
                targetURL={PageRoutes.SCALING_OPTIMIZING_API}
            />
        </>
    );
}